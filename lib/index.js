...
exports.Service = class Service {
    ...
    caching(options) {
        ...
        Object.keys(options).forEach((methodName) => {
            ...
            Assert.ok(typeof this[methodName] !== 'undefined', `The key ${methodName} does not exist.`);
            Assert.ok(typeof this[methodName] === 'function', `The key ${methodName} must be a method.`);
